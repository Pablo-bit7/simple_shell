...
/**
* add_node - This func adds a node to the start of the list
* @head: The address of pointer to 1st node
* @str: Field of node
...
/**
* print_list_str - This prints only the str element of a list_t
...
/**
* free_list - This simply frees all nodes of a list
