...
/**
* input_buf - Buffer chained commands in an input buffer.
...
/**
* get_input - Get input line without the newline character.
* @info: Parameter structure
* Return: Number of bytes read
*/
...
* Return: The result as a string (s)
*/
...
/**
* sigintHandler - Signal handler for blocking Ctrl-C (SIGINT).
